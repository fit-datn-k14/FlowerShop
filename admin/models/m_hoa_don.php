...
class M_hoa_don extends database
{
    ...
    {
        $sql="SELECT * FROM hoa_don inner join khach_hang on khach_hang.ma_khach_hang=hoa_don.ma_khach_hang where trang_thai='Đã xử lý' OR trang_thai='Hoàn Thành' ORDER BY trang_thai";
        return $this->loadAllRows($sql);
    }
